...
class PI3NNDir():
    ...
    def x_path(self) -> Path:
        return self.path / "x.npy"

    @property
    def u_data_path(self) -> Path:
        return self.path / "u_data.npy"

    @property
    def u_pred_mean_path(self) -> Path:
        return self.path / "u_pred_mean.npy"

    @property
    def u_pred_median_path(self) -> Path:
        return self.path / "u_pred_median.npy"
    ...
    @property
    def u_pred_upper_res_path(self) -> Path:
        return self.path / "u_pred_upper_res.npy"

    @property
    def u_pred_lower_res_path(self) -> Path:
        return self.path / "u_pred_lower_res.npy"
